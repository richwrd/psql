...
/*===========================================================================
					...
					Permiss�o em schema por usuario
	exemplo:
	
		---------------------<�� GRANT / REVOKE ��>-----------------------
	
			Usuario RECEBE permiss�es setadas APENAS como   >> TRUE  <<	
			Usuario PERDE permiss�es setadas APENAS como 	>> FALSE <<	
...
/*---------------------<�� SELECT TRUE ��>-----------------------*/
			...
			/* se permiss�o de SELECT for autorizada */
			if(info_r.p_select) then
			
			/* permiss�o de usar o esquema antes das demais */
			execute format('GRANT USAGE ON SCHEMA %I TO %I', info_r.schema_nome, info_r.usuario_login);
				...
				for recursiva_tables in (select
					...
					loop
						/* da permiss�o pra todas tabelas encontradas no schema */						
				...
				for recursiva_sequencia in (select
					...
					loop
						/* da permiss�o pra todas sequencias encontradas no schema */						
...
/*---------------------<�� INSERT TRUE ��>-----------------------*/
			...
			/*se permiss�o de INSERT for autorizada*/
...
/*---------------------<�� UPDATE TRUE ��>-----------------------*/
			...
			/*se permiss�o de UPDATE for autorizada*/
...
/*---------------------<�� DELETE TRUE ��>-----------------------*/
			...
			/*se permiss�o de DELETE for autorizada*/
...
/*---------------------<�� DELETE FALSE ��>-----------------------*/
	...
	/*fim do if */
		...
		return 'Todos usu�rios est�o validados, n�o h� nada a fazer.';	
	end if;
